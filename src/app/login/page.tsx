      ...
      <main className="flex-1 flex items-center justify-center px-4 py-12 relative">
        ...
        <Card className="w-full max-w-md shadow-xl z-10 bg-white/40 dark:bg-gray-900/40 backdrop-blur-md border border-white/30 dark:border-gray-800/50">
          <div className="p-6">
            ...
            <h1 className="text-2xl font-bold text-center mb-6 bg-gradient-to-r from-primary via-purple-600 to-blue-600 text-transparent bg-clip-text">Sign In</h1>
            <LoginForm />
          ...
          <form onSubmit={handleForgotPassword} className="space-y-4">
            <div className="space-y-1">
              ...
              <Input
                ...
                className="h-10 bg-white/70 dark:bg-gray-800/70 border-gray-300/50 dark:border-gray-700/50"
                required
              />
            </div>
